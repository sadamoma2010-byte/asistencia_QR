...
DEFINICIONES: dict[str, dict] = {
    "docentes": {
        ...
        "columnas": [
            ...
            _columna("courses", "Cursos", tipo="cursos"),
        ...
        "filtros": [
            ...
            {"tipo": "catalogo", "campo": "gradeId", "recurso": "grades", "texto": "Todos los grados"},
            {"tipo": "catalogo", "campo": "courseId", "recurso": "courses", "texto": "Todos los cursos"},
        ],
    },
    "asignaturas": {
        "recurso": "subjects",
    ...
    "grados": {
        "recurso": "grades",
        "titulo": "Grados",
        "descripcion": "Los establece la Ley 115 de 1994. Active los que ofrezca la institución.",
        "singular": "grado",
        "permiso": "grades",
        "ordenar": "position",
        "columnas": [
            _columna("name", "Grado", tipo="destacado", ordenable="position"),
            _columna("code", "Código", tipo="insignia", ordenable="code"),
            _columna("level", "Nivel", tipo="nivel", ordenable="level"),
            _columna("_count.courses", "Cursos", tipo="contador"),
            _columna("description", "Descripción", tipo="texto"),
            _columna("status", "Se ofrece", tipo="estado", ordenable="status"),
        ],
        "filtros": [
            {"tipo": "busqueda", "campo": "search", "texto": "Buscar por grado o código"},
            {"tipo": "opciones", "campo": "level", "texto": "Todos los niveles",
             "opciones": [("PREESCOLAR", "Preescolar"),
    ...
    "cursos": {
        "recurso": "courses",
        "titulo": "Cursos",
        "descripcion": "Grupos de cada grado: 6A, 6B, 6C. Abra los que necesite según su matrícula.",
        "singular": "curso",
        "permiso": "courses",
        "ordenar": "name",
        "columnas": [
            _columna("name", "Curso", tipo="destacado", ordenable="name"),
            _columna("grade.name", "Grado", tipo="anidado"),
            _columna("grade.level", "Nivel", tipo="nivel"),
            _columna("shift.name", "Jornada", tipo="anidado"),
            _columna("homeroomTeacher", "Director de grupo", tipo="docente_director"),
            _columna("capacity", "Cupo", tipo="cupo", ordenable="capacity"),
            _columna("_count.teachers", "Docentes", tipo="contador"),
            _columna("status", "Estado", tipo="estado", ordenable="status"),
        ],
        "filtros": [
            {"tipo": "busqueda", "campo": "search", "texto": "Buscar por curso o grado"},
            {"tipo": "catalogo", "campo": "gradeId", "recurso": "grades", "texto": "Todos los grados"},
            {"tipo": "catalogo", "campo": "shiftId", "recurso": "shifts", "texto": "Todas las jornadas"},
            {"tipo": "catalogo", "campo": "teacherId", "recurso": "teachers", "texto": "Todos los docentes"},
            {"tipo": "estado"},
    ...
    "horarios": {
        ...
        "columnas": [
            ...
            _columna("course.name", "Curso", tipo="anidado"),
